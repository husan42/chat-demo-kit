...
- 七種功能卡：在你的工具裡工作、做一次給它看、越用越懂、互相接力、成效清單、AI 標籤、貼文留言
- 兩種情境：Grok Bot 式的「老闆和 AI 小編」，或真實的「客服收件匣」
...
demos/
  ...
  kufu-inbox/             Kufu 官網用：真實收件匣畫面（顧客 ↔ AI 客服 ↔ 真人客服）
  kufu-ai-teammates/      Kufu 概念版：店長和 AI 小編對話（提案用，產品沒有這個介面）
